...
NAME_USER_ADMIN_ADD = "Введите имя пользователя, которого хотите сделать администратором!"
ANSWER_NOT_FOUND_USER = (
    "Пользователь не найден, либо он не пользуется этим сервисом! \nВведите имя пользователя еще раз!"
)
